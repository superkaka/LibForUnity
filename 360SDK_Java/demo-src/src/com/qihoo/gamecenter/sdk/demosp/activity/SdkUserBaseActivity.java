...
public abstract class SdkUserBaseActivity extends UnityPlayerActivity{
    ...
    protected void onGotUserInfo(QihooUserInfo userInfo,String json) {

    }
    
    protected void onGotToken(String token) {
    	
    }

    private void getUserInfo() {
    	
    	//中断，将mAccessToken传给unity  请求我们的应用服务器获取用户信息
    	onGotToken(mAccessToken);
        ...
        mUserInfoTask.doRequest(this, mAccessToken, Matrix.getAppKey(this), new QihooUserInfoListener() {
            ...
            public void onGotUserInfo(QihooUserInfo userInfo,String json) {
                ...
                if (null == userInfo || !userInfo.isValid()) {
                    ...
                    SdkUserBaseActivity.this.onGotUserInfo(userInfo, json);
                }
            }
        });
...
//                                    Log.d(TAG, "status = " + status);
     ...
     * @return QihooPay
     */
    protected QihooPayInfo getQihooPay(String moneyAmount) {
